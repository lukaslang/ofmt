...
function [Dx, Dy] = vecderiv2dc(m, n, hx, hy)
%VECDERIV2DC Creates vectorised central first difference matrices for 2D.
%
%   [Dx, Dy] = VECDERIV2DC(m, n, hx, hy) takes the number of columns m, the 
