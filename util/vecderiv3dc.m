...
function [Dx, Dy, Dz] = vecderiv3dc(m, n, t, hx, hy, hz)
%VECDERIV3DC Creates vectorised central first difference matrices for 3D.
%
%   [Dx, Dy, Dz] = VECDERIV3DC(m, n, t, hx, hy, hz) takes the number of 
...
%   central difference matrices Dx Dy, and forward difference matrix Dz,
%   all with Neumann boundary conditions.
%
