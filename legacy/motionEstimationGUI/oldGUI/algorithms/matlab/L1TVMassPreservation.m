...
%
function [x,y] = L1TVMassPreservation(image1,image2,tol,lambda,varargin)
    ...
    while err>tol && iterations < maxIt
        ...
        if (mod(iterations,100)==1)
            reverseStr = printToCmd( reverseStr,sprintf('L1-TV Mass Preservation, Iteration: #%d : Residual %f',iterations,err) );
